      ...
      <Container>
        <Row>
          <Col className="text-left" md="6">
            <h1 className="title">Another Hero Section</h1>
            <h5>
              ...
              unveiling a gorgeous looking website that blasts past the cast in
              last. Also I've got millions of beautiful photos that come royalty
              free...
            </h5>
            <br />
              ...
              <Container>
                <Row>
                  ...
                  <Col className="ml-auto" md="6">
                    <h2 className="title">This is a "Hero Section"</h2>
                    <h5 className="description">
                      EXPLAIN A HERO SECTION. There's no doubt that Tesla is
                      delighted with the interest, but the data also raises a
                      few questions. How long will it take for Tesla to fulfill
                      all those extra orders? And how come they keep killing
                      people? And why is Elong Must so insufferable? I have a
                      Tesla, but I'm almost embarassed to drive it now. Kidding,
                      I'm a rational person. I'd never buy a Tesla. But you can
                      sell them or anything else via the button below. That's
                      what a Hero Section is all about.
                    </h5>
                    <br />
                    <Button
                      color="danger"
          ...
          >
            ...
            <div className="content-center">
              <Container>
                <Row>
                  <Col className="ml-auto mr-auto text-center" md="8">
                    <h1 className="title">Hero Section Two</h1>
                    <h5 className="description">
                      ...
                      potential if it's not by getting the best web design for
                      the price. Just do it. Especially if you have the money. I
                      work so much better when my clients aren't pinching me all
                      over...
                    </h5>
                    <br />
                  </Col>
