...
function SectionHeader() {
  return (
    <>
      {/* WORK ON THESE "FEATURES - BECAUSE YOU ONLY DID ONE AND YOU'RE BORED" */}
          ...
          <Container>
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                <h2 className="title">Why we do our best work</h2>
                <h5 className="description">
                  We never thought designing for the web would ever be nearly
                  this fun. All the things we are now capable of couldn't have
                  even been imagined a generation ago. It's simply electrifying
                  and exhilerating to be working with amazing teams to create
                  amazing products. Money is just a formality at this point.
                </h5>
              </Col>
            </Row>
            <Row>
          ...
          <Container>
            ...
            <Row>
              ...
              <Col md="4">
                ...
                >
                  <CardBody>
                    <h6 className="card-category">UX</h6>
                    <div className="card-icon">
