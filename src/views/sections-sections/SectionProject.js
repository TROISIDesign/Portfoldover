          ...
          <Container>
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                <h2 className="title">Awesome Product Page - 1</h2>
              ...
              <Col md="7">
                <Card
                  ...
                  style={{
                    backgroundImage:
                      "url(" +
                      require("assets/img/sections/gukhwa-jang.jpg").default +
                      ")",
                  }}
                >
                  <CardBody>
          ...
          <Container>
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                ...
                <h2 className="title">Awesome Product Page 2</h2>
                <h5 className="description">
                  This is the paragraph where you can write more details about
                  your projects. Keep you user engaged by providing meaningful
                  information.
                  ...
                  <CardImg top tag="div">
                    ...
                    >
                      <img
                        ...
                        className="img"
                        src={
                          require("assets/img/sections/opt_pk_react_thumbnail.jpg")
                            .default
                        }
                      />
                    </a>
                  ...
                  <CardImg top tag="div">
                    ...
                    >
                      <img
                        ...
                        className="img"
                        src={
                          require("assets/img/sections/argon-dashboard-pro-react.jpg")
                            .default
                        }
                      />
                    </a>
                  ...
                  <CardImg top tag="div">
                    ...
                    >
                      <img
                        ...
                        className="img"
                        src={
                          require("assets/img/sections/blk-design-system-pro-react.jpg")
                            .default
                        }
                      />
                    </a>
        ...
        <div className="projects-3" id="projects-3">
          <Container>
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                ...
                <h2 className="title">Awesome Product Page 3</h2>
              </Col>
            </Row>
            <Row>
              <Col md="4">
                  ...
                  <CardImg top tag="div">
                    ...
                    >
                      <img
                        ...
                        className="img"
                        src={
                          require("assets/img/sections/patrick-tomasso.jpg")
                            .default
                        }
                      />
                    </a>
                  ...
                  <CardImg top tag="div">
                    ...
                    >
                      <img
                        ...
                        className="img"
                        src={
                          require("assets/img/sections/luke-chesser.jpg")
                            .default
                        }
                      />
                    </a>
          ...
          <div className="project-4 section section-dark">
            <Container>
              <Row>
                <Col className="ml-auto mr-auto text-center" md="8">
                  <h2 className="title">Awesome Product Page 4</h2>
                  <h5 className="description">
                    This is the paragraph where you can write more details about
                    your projects. Keep you user engaged by providing meaningful
                    information.
                ...
                <Col className="mr-auto" md="5">
                  <Card
                    ...
                    style={{
                      backgroundImage:
                        "url(" +
                        require("assets/img/sections/john-towner.jpg").default +
                        ")",
                    }}
                  >
                    <div className="card-icon">
